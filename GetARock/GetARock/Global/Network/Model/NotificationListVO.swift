...
extension NotificationListVO {
    static var testData: [NotificationInfo] = [
        ...
        NotificationInfo(alertID: 0, isInvitation: false, alertType: "", title: "‘블랙로즈' 하고싶은 말 🦹", content: "밴드 ‘블랙로즈'에 새로운 하고싶은 말이 달렸어요!", isChecked: false, updatedDate: "2023-02-23 11:33", bandID: 1, eventID: -1),
